...
in_cat <- list.files(in_hto, pattern = "hto_category_table", full.names = TRUE)

if(!file.exists(in_cat)) {
  stm(paste0("ERROR: Cannot find HTO category table:", in_cat))
  stop()
} else {
  stm(paste0("Found HTO category table:", in_cat))
}
```
