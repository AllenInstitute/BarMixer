...
print(c(
  ...
  paste0("IN  SampleSheet.csv : ", in_samples),
...
if(!file.exists(in_samples)) {
  stm(paste0("ERROR: Cannot find IN SampleSheet file:", in_samples))
  stop()
}
```
...
#### Load SampleSheet
```{r Load SampleSheet}
stm(paste0("Reading SampleSheet from ",in_samples))
ss <- read.csv(in_samples)
